// remplace el switch con un fotodiodo
...
void loop() {
  //lectura de sensor de fotodiodo
  int sensorValue = analogRead(fotodiodo);
  int precionado = teclaPrecionado();

  //pregunta valor del sensor
  if (sensorValue < 585) {
  ...
  {
    // Mostrar números primos entre 0 y 99
    muestraNumerosPrimos();
    delay(25);
  }
